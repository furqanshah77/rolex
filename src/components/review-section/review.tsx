...
const Review = () => {
  return (
    <div className="grid lg:grid-cols-2 sm:gap-y-32 md:gap-y-32 gap-y-14 gap-x-28  h-fit md:mt-10 ">
      <div className="justify-self-end w-fit">
        <div className="flex px-10 flex-col gap-y-5 w-fit xl:px-28">
      ...
      <div className="flex flex-col gap-y-5 justify-center items-center lg:items-start w-full h-fit ">
